import bg1all from "../assets/images/imgComunities/allBg1.svg";
import homeleft from "../assets/images/btmhomeleft.svg";
import homeright from "../assets/images/btmhomeright.svg";

import iconNwdc from "../assets/images/imgComunities/Nwdc/Icon.svg";
import logoNwdc from "../assets/images/imgComunities/Nwdc/Logo.svg";
...
import or2Nwdc from "../assets/images/imgComunities/Nwdc/Orn2.svg";

import iconNuxc from "../assets/images/imgComunities/Nuxc/Icon.svg";
import logoNuxc from "../assets/images/imgComunities/Nuxc/Logo.svg";
...
const data = [
  {
    id: 1,
    path: "NWDC",
    title: "NIGHT LOGIN WEB \nDEVELOPMENT COMMUNITY",
    desc: "NWDC (Nightlogin Web Development Community) merupakan komunitas bagi mahasiswa yang memiliki ketertarikan kepada web, baik itu web development maupun web design.",
    pName: "KIM MINJI",
    vpName: "KIM MINJI",
    bg1: bg1all,
    btmleft: homeleft,
  ...
  },
  {
    id: 2,
    path: "NUXC",
    title: "NIGHT LOGIN USER \nEXPERIENCE COMMUNITY",
    desc: "Komunias NUXC (Night Login User Experience Community) merupakan komunitas bagi mahasiswa yang menyenangi ataupun ingin menggeluti user experience.",
    pName: "KIM MINJI",
    vpName: "KIM MINJI",
    bg1: bg1all,
    btmleft: homeleft,
  ...
  },
  {
    id: 3,
    path: "NCPC",
    title: "NIGHT LOGIN COMPETITIVE \nPROGRAMMING COMMUNITY",
    desc: "NCPC (Nightlogin Competitive Programming Community) merupakan komunitas bagi mahasiswa yang memiliki ketertarikan kepada competitive programming.",
    pName: "KIM MINJI",
    vpName: "KIM MINJI",
    bg1: bg1all,
    btmleft: homeleft,
  ...
  },
  {
    id: 4,
    path: "NLNC",
    title: "NIGHT LOGIN LINUX AND \nNETWORKING COMMUNITY",
    desc: "NLNC (Nightlogin Linux and Networking Community) merupakan komunitas bagi mahasiswa yang tertarik pada Linux dan Jaringan, seperti keamanan jaringan, dll.",
    pName: "KIM MINJI",
    vpName: "KIM MINJI",
    bg1: bg1all,
    btmleft: homeleft,
